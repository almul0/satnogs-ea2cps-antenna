...
%La realización más simple de la antena helicoidal axial es la unifilar. Consiste simplemente en un único conductor roscado desde un plano de tierra. Esta antena produce una radiación con polarización circular en el sentido de la rosca de la hélice y mantiene una impedancia de entrada constante para un ancho de banda apreciable.\\
%\begin{figure}[h]
%	\centering
