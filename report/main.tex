...
Para la realización de este trabajo se empleará el software 4nec2.
...
Los parámetros de la antena se obtienen a partir de las condiciones de diseño del modo axial descritas en la siguiente tabla.
...
\begin{tabular}{lc}
	...
	$n$ & $3 < n < 15$  \\ 
	\hline 
	Diámetro del plano de tierra & $D_{GND} > \lambda/2$ \\ 
	\hline 
...
Para un diseño óptimo: $C \simeq \lambda_0$ y $\alpha \simeq 13°$, siendo $\lambda_0$ la longitud de onda en el vacío. Fijando estos parámetros se obtienen $S$ y $L$:
\begin{equation}
...
Con estas condiciones de diseño se procede a su simulación mediante el software 4nec2. Dicho software calcula mediante el método de momentos la respuesta electromágnetica de antenas y estructuras metálicas. El software viene con un generador de geometrías que se puede utilizar para generar un archivo .nec con los segmentos del reflector o la hélice, aunque la hélice se puede generar con un tipo especial de hilo en el mismo editor del programa.

Se empieza simulando una hélice simple sin plano de tierra a una frecuencia de 435 MHz ($\lambda_0 = 68.965cm$)
